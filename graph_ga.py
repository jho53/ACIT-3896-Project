...
yn1 = y1 + 0.2*np.random.normal(size=len(x1))
...
ga100_data = plt.plot(x1, y1, label="GA (Population: 100)")
ga500_data = plt.plot(x2, y2, label="GA (Population: 500)")
...
plt.title("GA (Population: 100) vs GA (Population: 500)")
plt.legend()
plt.show()
